<template>
	<div class="">
		<MainNav/>
		<!--<MainBanner/>-->
		<MainAboutCompany class="container mt-3" id="about"/>
		<MainCollectiveCard class="bg-brand mt-5" id="commands"/>
		<!--<MainSilider class="container"/>-->
		<MainTabs class="container" id="ths"/>
		<MainGalleray class="bg-brand py-5 my-3" id="galleray"/>
		<MainFaq class="container"/>
		<div class="whatsapp-icon d-none d-md-block">
			<a href="https://api.whatsapp.com/send?phone=77777499679" class="pos-link">
		...
		<div class="go-top d-none d-md-block">
			<a class="pos-top d-flex d-flex-mob" onclick="document.querySelector('.bg-image-main').scrollIntoView()">
				<img srcset="https://img.icons8.com/external-those-icons-lineal-color-those-icons/344/external-arrow-arrows-those-icons-lineal-color-those-icons-1.png 2x" width="20px" height="20px" style="transform: rotate(-180deg);">
				<div class="ml-2">Наверх</div>
			</a>
		</div>
		<MainFooter/>
	</div>
